...
def create_business(
    ...
    Used by:
    - Normal owner registration flow
    - First-time Google user onboarding
    """

    # --------------------------------------------------------
    # Check whether owner already has a business
    # --------------------------------------------------------
    ...
    if existing:
        raise HTTPException(
            status_code=400,
            detail="User already owns a business",
        )
    ...
    business = Business(
        ...
        business_registration_number=(
            biz_in.business_registration_number
        ),
    ...
    # DO NOT set unique_code manually.
    # PostgreSQL generates it using server_default.

    db.add(business)
    db.flush()

    # --------------------------------------------------------
    # Connect owner with business
    # --------------------------------------------------------
