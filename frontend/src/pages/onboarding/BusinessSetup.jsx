...
const canSubmit = useMemo(() => (
  ...
  const handleSubmit = async (e) => {
    ...
    if (!canSubmit) {
      ...
      if (!formData.name.trim() || !formData.business_type || !formData.industry.trim()) {
        setStep(1);
      } else {
        setStep(2);
      }
          ...
          {step === 2 && (
            <div className="space-y-5">
              ...
              <div className="flex gap-3">
                ...
                <button type="submit" disabled={loading || !canSubmit} className="flex-[2] py-3 bg-brand-600 hover:bg-brand-700 disabled:opacity-50 text-white rounded-xl text-sm font-bold shadow-md flex items-center justify-center gap-2">
